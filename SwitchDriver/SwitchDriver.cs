...
//
// ASCOM Switch driver for naixxWanderer
//
...
namespace ASCOM.naixxWanderer.Switch
{
    //
    ...
    //
    // Your driver's DeviceID is ASCOM.naixxWanderer.Switch
    //
    // The COM Guid attribute sets the CLSID for ASCOM.naixxWanderer.Switch
    // The COM ClassInterface/None attribute prevents an empty interface called _naixxWanderer from being created and used as the [default] interface
    //
    ...
    public class Switch : ReferenceCountedObjectBase, ISwitchV2, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="naixxWanderer"/> class. Must be public to successfully register for COM.
        /// </summary>
        public Switch()
        {
            try
            {
                ...
                tl = new TraceLogger("", "naixxWanderer.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show($"{ex.Message}", "Exception creating ASCOM.naixxWanderer.Switch", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
