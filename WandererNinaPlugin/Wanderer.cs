using Naixx.NINA.Wanderer.Properties;
...
using Settings = Naixx.NINA.Wanderer.Properties.Settings;
...
namespace Naixx.NINA.Wanderer {
    ...
    /// The user interface for the settings will be defined by a DataTemplate with the key having the naming convention "Wanderer_Options" where Wanderer corresponds to the AssemblyTitle - In this template example it is found in the Options.xaml
    /// </summary>
    [Export(typeof(IPluginManifest))]
    public class Wanderer : PluginBase, INotifyPropertyChanged {
